...
__export(index_exports, {
  MiniSamSegmenter: () => MiniSamSegmenter,
  applyMaskToImage: () => applyMaskToImage,
  canvasToBlob: () => canvasToBlob,
  downloadCanvas: () => downloadCanvas,
  getMaskBounds: () => getMaskBounds,
  maskToCanvas: () => maskToCanvas,
  trimCanvasToContent: () => trimCanvasToContent,
  useMiniSam: () => useMiniSam
});
module.exports = __toCommonJS(index_exports);

// src/components/MiniSamSegmenter.tsx
var import_react = require("react");
var import_minisam = require("minisam");
var import_clsx = __toESM(require("clsx"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var MiniSamSegmenter = (0, import_react.forwardRef)(
  ({
    image,
    autoInit = true,
    ...
    const [loadedImage, setLoadedImage] = (0, import_react.useState)(
      null
    );
    const [clicks, setClicks] = (0, import_react.useState)([]);
    const [clickMode, setClickMode] = (0, import_react.useState)(initialClickMode);
    const [mask, setMask] = (0, import_react.useState)(null);
    const [session, setSession] = (0, import_react.useState)(null);
    const containerRef = (0, import_react.useRef)(null);
    const imageCanvasRef = (0, import_react.useRef)(null);
    const maskCanvasRef = (0, import_react.useRef)(null);
    const imageElementRef = (0, import_react.useRef)(null);
    (0, import_react.useEffect)(() => {
      if (!autoInit) return;
      const init = async () => {
        try {
          setIsLoading(true);
          await (0, import_minisam.initSegmentation)();
    ...
    (0, import_react.useEffect)(() => {
      ...
      const loadImage = async () => {
        try {
          ...
          await (0, import_minisam.precomputeEmbedding)(img);
          const newSession = (0, import_minisam.createSession)(img);
    ...
    const undo = (0, import_react.useCallback)(async () => {
    ...
    const segmentWithClicks = (0, import_react.useCallback)(
      async (newClicks) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: containerRef, className: (0, import_clsx.default)("minisam-container", className), children: [
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "canvas",
              {
                ...
                className: (0, import_clsx.default)("minisam-image-canvas", imageClassName, {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ...
              {
                ref: maskCanvasRef,
                className: (0, import_clsx.default)("minisam-mask-canvas", maskClassName),
                style: {
                  position: "absolute",
                  top: 0,
                  left: 0,
            ...
            showClickMarkers && loadedImage && clicks.map((click, index) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "div",
                {
                  className: (0, import_clsx.default)("minisam-click-marker", clickMarkerClassName),
                  style: {
                    position: "absolute",
                    left: `${left}px`,
                    top: `${top}px`,
...
var import_minisam2 = require("minisam");
function useMiniSam(options = {}) {
  ...
  const [clicks, setClicks] = (0, import_react2.useState)([]);
  const [mask, setMask] = (0, import_react2.useState)(null);
  ...
  const initialize = (0, import_react2.useCallback)(async () => {
    ...
    initPromiseRef.current = (async () => {
      try {
        setIsLoading(true);
        await (0, import_minisam2.initSegmentation)();
        setIsInitialized(true);
        onInitialized?.();
      } catch (error) {
        console.error("Failed to initialize miniSAM:", error);
  ...
  const loadImage = (0, import_react2.useCallback)(
    async (source) => {
      ...
      try {
        ...
        setClicks([]);
        setMask(null);
        await (0, import_minisam2.precomputeEmbedding)(img);
        sessionRef.current = (0, import_minisam2.createSession)(img);
      } catch (error) {
        console.error("Error loading image:", error);
        onError?.(error);
        throw error;
  ...
  const addClick = (0, import_react2.useCallback)(
  ...
  const removeLastClick = (0, import_react2.useCallback)(async () => {
  ...
  const segment = (0, import_react2.useCallback)(async () => {
  ...
  const segmentWithClicks = (0, import_react2.useCallback)(
    async (newClicks) => {
      if (!image || !sessionRef.current) {
        throw new Error("No image loaded");
      }
  ...
  const extractMaskAsCanvas = (0, import_react2.useCallback)(() => {
  ...
  const extractMaskAsBlob = (0, import_react2.useCallback)(
